...
public class M extends android.app.Activity {
    ...
    static public String GenerateArticle(String theme) {
        ...
        while (chaptersLength < 6000) {
            ...
            if (rand < 5 && chapters.length() > 200) {
                ...
                if (rand < 20) {
                    sentence = RandomOneSentence(quotes).replace("曾经说过", RandomOneSentence(front)).replace("这不禁令我深思", RandomOneSentence(back));
                } else {
                    sentence = RandomOneSentence(discuzz).replace("主题", theme);
                }
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        l.addView(e1, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        l.addView(b, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        l.addView(e2, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);

        setContentView(l);
        b.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                e2.setText(GenerateArticle(e1.getText().toString()));
            }
        });
    }
}